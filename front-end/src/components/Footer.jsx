        ...
        <footer className="footer">
            <div className="footer__container">
                ...
                <div className="footer__contacto">
                    <a href="/politicas" target="_blank" className="footer__contacto__enlace">Aviso Legal</a>
                    ...
                    <a href="/politicas#condicion-reserva" target="_blank"  className="footer__contacto__enlace">Condiciones de reserva</a>
                </div>
            </div>
        </footer>
    )
