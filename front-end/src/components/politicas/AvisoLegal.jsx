...
export function AvisoLegal() {
    return (
        <div className="subcontainer-politicas" id='aviso-legal'>
            ...
            <section className='section-politicas'>
                <h3 className='subtitulo'>5. OBLIGACIONES Y RESPONSABILIDADES DEL USUARIO DEL ESPACIO WEB</h3>
                <p>El Usuario se compromete a:</p>
                <ol className='lista-numerica lista' >
                    <li>
                        <p>Hacer un uso adecuado y lícito del Espacio Web así como de los contenidos y servicios, de conformidad con:</p>
                        <ul className='lista'><br />
                            <li>La legislación aplicable en cada momento;</li>
                            <li>Las Condiciones Generales de Uso del Espacio Web;</li>
                            <li>La moral y buenas costumbres generalmente aceptadas; y</li>
                            <li>El orden público.</li><br />
                        </ul>
                    </li>
            ...
            <section className='section-politicas'>
                <h3 className='subtitulo'>7. HIPERVÍNCULOS</h3>
                <p className='p-indent'>El Usuario se obliga a no reproducir de ningún modo, ni siquiera mediante un hiperenlace o hipervínculo, el Espacio Web, así como ninguno de sus contenidos, salvo autorización expresa y por escrito del responsable del fichero.</p>
            ...
            <section className='section-politicas'>
                <h3 className='subtitulo'>8. PROTECCIÓN DE DATOS</h3>
                <p className='p-indent'>Para utilizar algunos de los Servicios, el Usuario debe proporcionar previamente ciertos datos de carácter personal. La empresa tratará automatizadamente estos datos y aplicará las correspondientes medidas de seguridad, todo ello en cumplimiento del RGPD, LOPDGDD y LSSI. El Usuario puede acceder a la política seguida en el tratamiento de los datos personales, así como el establecimiento de las finalidades previamente establecidas, en las condiciones definidas en la Política de Privacidad.</p>
            </section>
            <section className='section-politicas'>
                <h3 className='subtitulo'>9. COOKIES</h3>
                <p className='p-indent'>La empresa se reserva el derecho de utilizar la tecnología “cookie” en el Espacio Web, a fin de reconocerlo como Usuario frecuente y personalizar el uso que realice del Espacio Web mediante la preselección de su idioma, o contenidos más deseados o específicos.</p>
            ...
            <section className='section-politicas'>
                <h3 className='subtitulo'>10. DECLARACIONES Y GARANTÍAS</h3>
                <p className='p-indent'>En general, los contenidos y servicios ofrecidos en el Espacio Web tienen carácter meramente informativo. Por consiguiente, al ofrecerlos, no se otorga garantía ni declaración alguna en relación con los contenidos y servicios ofrecidos en el Espacio web, incluyendo, a título enunciativo, garantías de licitud, fiabilidad, utilidad, veracidad, exactitud, o comerciabilidad, salvo en la medida en que por ley no puedan excluirse tales declaraciones y garantías.</p>
            </section>
            <section className='section-politicas'>
                <h3 className='subtitulo'>11. FUERZA MAYOR</h3>
                <p className='p-indent'>La empresa no será responsable en todo en caso de imposibilidad de prestar servicio, si ésta se debe a interrupciones prolongadas del suministro eléctrico, líneas de telecomunicaciones, conflictos sociales, huelgas, rebelión, explosiones, inundaciones, actos y omisiones del Gobierno, y en general todos los supuestos de fuerza mayor o de caso fortuito.</p>
            </section>
            <section className='section-politicas'>
                <h3 className='subtitulo'>12. RESOLUCIÓN DE CONTROVERSIAS. LEY APLICABLE Y JURISDICCIÓN</h3>
                <p className='p-indent'>Las presentes Condiciones Generales de Uso, así como el uso del Espacio Web, se regirán por la legislación española. Para la resolución de cualquier controversia las partes se someterán a los Juzgados y Tribunales del domicilio social del Responsable del sitio web.</p>
