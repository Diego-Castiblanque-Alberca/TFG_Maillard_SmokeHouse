...
export function Privacidad() {
    return (
        <div className="subcontainer-politicas" id='privacidad'>
            <h2 className='titulo-principal'>POLÍTICA DE PRIVACIDAD</h2>
            <section className='section-politicas'>
                <h3 className='subtitulo'>1. INFORMACIÓN AL USUARIO</h3>
                <p className='p-indent'>Maillard S.L., como Responsable del Tratamiento, le informa que, según lo dispuesto en el Reglamento (UE) 2016/679, de 27 de abril, (RGPD) y en la L.O. 3/2018, de 5 de diciembre, de protección de datos y garantía de los derechos digitales (LOPDGDD), trataremos su datos tal y como reflejamos en la presente Política de Privacidad.</p>
            ...
            <section className='section-politicas'>
                <h3 className='subtitulo'>5. LEGITIMIDAD</h3>
                <p className='p-indent'>De acuerdo con la normativa de protección de datos aplicable, sus datos personales podrán tratarse siempre que:</p>
                <ul className='lista'>
            ...
            <section className='section-politicas'>
                <h3 className='subtitulo'>6. COMUNICACIÓN DE DATOS PERSONALES</h3>
                <p className='p-indent'>Los datos pueden ser comunicados a empresas relacionadas con Maillard S.L. para la prestación de los diversos servicios en calidad de Encargados del Tratamiento. La empresa no realizará ninguna cesión, salvo por obligación legal.</p>
            </section>
            <section className='section-politicas'>
                <h3 className='subtitulo'>7. SUS DERECHOS</h3>
                <p className='p-indent'>En relación con la recogida y tratamiento de sus datos personales, puede ponerse en contacto con nosotros en cualquier momento para:</p>
                <ul className='lista'>
            ...
            <section className='section-politicas'>
                <h3 className='subtitulo'>8. INFORMACIÓN LEGAL</h3>
                <p className='p-indent'>Los requisitos de esta Política complementan, y no reemplazan, cualquier otro requisito existente bajo la ley de protección de datos aplicable, que será la que prevalezca en cualquier caso.</p>
